...
class Sensor_MPU6050 {
  ...
  public:
    Sensor_MPU6050(uint8_t scl, uint8_t sda) {
      _scl = scl;
      _sda = sda;
    }
    ...
    double* getData(){
      ...
      data[0] = (double)AccelX / AccelScaleFactor;
      data[1] = (double)AccelY / AccelScaleFactor;
      data[2] = (double)AccelZ / AccelScaleFactor;
      data[3] = (double)Temperature / 340 + 36.53; //temperature formula
      data[4] = (double)GyroX / GyroScaleFactor;
      data[5] = (double)GyroY / GyroScaleFactor;
      data[6] = (double)GyroZ / GyroScaleFactor;
      return data;
      }
